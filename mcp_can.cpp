...
static SPIClass CAN_SPI(HSPI);

#define spi_readwrite CAN_SPI.transfer
...
{
    CAN_SPI.beginTransaction(SPISettings(10000000, MSBFIRST, SPI_MODE0));
    MCP2515_SELECT();
