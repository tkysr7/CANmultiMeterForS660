...
extern const uint8_t mcp_cs_pcf8574_pin;
...
#define MCP_8MHz_500kBPS_CFG1 (0x40)
...
#define MCP_10MHz_1000kBPS_CFG2 (0x)  /* Enabled SAM bit     */
#define MCP_10MHz_1000kBPS_CFG3 (0x)  /* Sample point at 75% */

#define MCP_10MHz_500kBPS_CFG1 (0x40)
#define MCP_10MHz_500kBPS_CFG2 (0x)   /* Enabled SAM bit     */
#define MCP_10MHz_500kBPS_CFG3 (0x)   /* Sample point at 75% */
...
#define MCP2515_SELECT()  pcf.digitalWrite(mcp_cs_pcf8574_pin, LOW)
#define MCP2515_UNSELECT()  pcf.digitalWrite(mcp_cs_pcf8574_pin, HIGH)
